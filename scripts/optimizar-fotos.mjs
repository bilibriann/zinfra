...
const MAPA = [
  ...
  ['valvulas/globo.webp', `${ORIGENES}/WATSON MCDANIEL/DJ41NPT.jpg`],
  ['valvulas/aguja.webp', `${ORIGENES}/WATSON MCDANIEL/Valvula aguja laton.jpg`],
  ['valvulas/seguridad.webp', `${ORIGENES}/WATSON MCDANIEL/W210-0.jpg`],
  ...
  ['instrumentacion/diferencial.webp', `${ORIGENES}/DE WIT/PMD100.jpg`],
  ['instrumentacion/transmisores.webp', `${ORIGENES}/WATSON MCDANIEL/Transmisor de Presión 1.png`],
...
for (const [nombre, origen] of MAPA) {
  ...
  console.log(`${nombre.padEnd(36)} ${String(kb).padStart(4)} kB  <- ${path.basename(origen)}`)
}
